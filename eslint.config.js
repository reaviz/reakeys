...
export default tseslint.config({ ignores: ['dist/', 'storybook-static/', 'node_modules/', 'coverage/'] }, js.configs.recommended, react.configs.flat.recommended, reactHooks.configs.flat.recommended, ...storybook.configs['flat/recommended'], prettier, {
  files: ['**/*.{js,ts,tsx}'],
  languageOptions: {
